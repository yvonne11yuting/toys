...
const BurgerButton = () => {
  ...
  return (
    <div
      className={cn(
        "relative h-8 w-8 cursor-pointer md:hidden hover:bg-inherit",
        {
