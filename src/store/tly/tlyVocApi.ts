...
export const tlyVocApi = createApi({
  ...
  baseQuery: fetchBaseQuery({
    baseUrl:
      "https://script.google.com/macros/s/AKfycbyFnfw1apOYyP2LgT4NZdM2-btZD8uj9DeCGhaM7PUJdSfzunchBUQuzrcSVIQENcdPXg/exec",
  }),
    ...
    getVocabularies: builder.query<object, string>({
      ...
      transformResponse: (response: ApiResponse) => {
        return response.data.filter(
          (item: Vocabulary) => !!item.question && !!item.answer,
        );
      },
    }),
  }),
